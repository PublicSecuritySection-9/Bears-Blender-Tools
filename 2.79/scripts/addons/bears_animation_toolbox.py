...
def export_action_internal(context, armature, action, scene, filepath):
    ...
    # use action's first and last keyframes as start and end
    startFrame = None
    endFrame = None

    # OR use pose markers! If one is found, it will be used as the end point

    pose_markers = sorted(action.pose_markers, key=lambda marker: marker.frame)

    start_marker = None
    end_marker = None

    num_pose_markers = len(pose_markers)

    if num_pose_markers == 1:
        startFrame = 0
        endFrame = pose_markers[0].frame
        end_marker = pose_markers[0]
    elif num_pose_markers > 1:  # if two or more are found, use the first two for in and out points
        startFrame = pose_markers[0].frame
        endFrame = pose_markers[1].frame
        start_marker = pose_markers[0]
        end_marker = pose_markers[1]
...
def setup_deformable_bones(context):
    ...
    bones_to_un_deform = ["DEF-chest", "DEF-f_index.01.L.01", "DEF-f_index.01.L.02", "DEF-f_index.01.R.01",
                          "DEF-f_index.01.R.02", "DEF-f_index.02.L", "DEF-f_index.02.R", "DEF-f_index.03.L",
                          "DEF-f_index.03.R",
                          "DEF-f_middle.01.L.01", "DEF-f_middle.01.L.02", "DEF-f_middle.01.R.01",
                          "DEF-f_middle.01.R.02", "DEF-f_middle.02.L",
                          "DEF-f_middle.02.R", "DEF-f_middle.03.L", "DEF-f_middle.03.R", "DEF-f_pinky.01.L.01",
                          "DEF-f_pinky.01.L.02",
                          "DEF-f_pinky.01.R.01", "DEF-f_pinky.01.R.02", "DEF-f_pinky.02.L", "DEF-f_pinky.02.R",
                          "DEF-f_pinky.03.L",
                          "DEF-f_pinky.03.R", "DEF-f_ring.01.L.01", "DEF-f_ring.01.L.02", "DEF-f_ring.01.R.01",
                          "DEF-f_ring.01.R.02",
                          "DEF-f_ring.02.L", "DEF-f_ring.02.R", "DEF-f_ring.03.L", "DEF-f_ring.03.R", "DEF-foot.L",
                          "DEF-foot.R",
                          "DEF-forearm.01.L", "DEF-forearm.01.R", "DEF-forearm.02.L", "DEF-forearm.02.R", "DEF-hand.L",
                          "DEF-hand.R",
                          "DEF-head", "DEF-hips", "DEF-neck", "DEF-palm.01.L", "DEF-palm.01.R", "DEF-palm.02.L",
                          "DEF-palm.02.R",
                          "DEF-palm.03.L", "DEF-palm.03.R", "DEF-palm.04.L", "DEF-palm.04.R", "DEF-shin.01.L",
                          "DEF-shin.01.R",
                          "DEF-shin.02.L", "DEF-shin.02.R", "DEF-shoulder.L", "DEF-shoulder.R", "DEF-spine",
                          "DEF-thigh.01.L",
                          "DEF-thigh.01.R", "DEF-thigh.02.L", "DEF-thigh.02.R", "DEF-thumb.01.L.01",
                          "DEF-thumb.01.L.02", "DEF-thumb.01.R.01",
                          "DEF-thumb.01.R.02", "DEF-thumb.02.L", "DEF-thumb.02.R", "DEF-thumb.03.L", "DEF-thumb.03.R",
                          "DEF-tie.00",
                          "DEF-tie.01", "DEF-tie.02", "DEF-toe.L", "DEF-toe.R", "DEF-upper_arm.01.L",
                          "DEF-upper_arm.01.R", "DEF-upper_arm.02.L",
                          "DEF-upper_arm.02.R", "ORG-heel.02.L", "ORG-heel.02.R", "ORG-heel.L", "ORG-heel.R",
                          "ORG-palm.01.L", "ORG-palm.01.R",
                          "ORG-palm.02.L", "ORG-palm.02.R", "ORG-palm.03.L", "ORG-palm.03.R", "ORG-palm.04.L",
                          "ORG-palm.04.R"
                          ]

    bones_to_deform = ["ORG-chest", "ORG-f_index.01.L", "ORG-f_index.01.R", "ORG-f_index.02.L", "ORG-f_index.02.R",
                       "ORG-f_index.03.L", "ORG-f_index.03.R", "ORG-f_middle.01.L", "ORG-f_middle.01.R",
                       "ORG-f_middle.02.L",
                       "ORG-f_middle.02.R", "ORG-f_middle.03.L", "ORG-f_middle.03.R", "ORG-f_pinky.01.L",
                       "ORG-f_pinky.01.R",
                       "ORG-f_pinky.02.L", "ORG-f_pinky.02.R", "ORG-f_pinky.03.L", "ORG-f_pinky.03.R",
                       "ORG-f_ring.01.L",
                       "ORG-f_ring.01.R", "ORG-f_ring.02.L", "ORG-f_ring.02.R", "ORG-f_ring.03.L", "ORG-f_ring.03.R",
                       "ORG-foot.L",
                       "ORG-foot.R", "ORG-forearm.L", "ORG-forearm.R", "ORG-hand.L", "ORG-hand.R", "ORG-head",
                       "ORG-hips", "ORG-neck",
                       "ORG-shin.L", "ORG-shin.R", "ORG-shoulder.L", "ORG-shoulder.R", "ORG-spine", "ORG-thigh.L",
                       "ORG-thigh.R",
                       "ORG-thumb.01.L", "ORG-thumb.01.R", "ORG-thumb.02.L", "ORG-thumb.02.R", "ORG-thumb.03.L",
                       "ORG-thumb.03.R",
                       "ORG-toe.L", "ORG-toe.R", "ORG-upper_arm.L", "ORG-upper_arm.R", "EXT-jaw", "EXT-eye.R",
                       "EXT-eye.L",
...
def hide_unused_bones(context):
    ...
    bones_to_hide = ["DEF-chest", "DEF-f_index.01.L.01", "DEF-f_index.01.L.02", "DEF-f_index.01.R.01",
                     "DEF-f_index.01.R.02",
                     "DEF-f_index.02.L", "DEF-f_index.02.R", "DEF-f_index.03.L", "DEF-f_index.03.R",
                     "DEF-f_middle.01.L.01", "DEF-f_middle.01.L.02",
                     "DEF-f_middle.01.R.01", "DEF-f_middle.01.R.02", "DEF-f_middle.02.L", "DEF-f_middle.02.R",
                     "DEF-f_middle.03.L", "DEF-f_middle.03.R",
                     "DEF-f_pinky.01.L.01", "DEF-f_pinky.01.L.02", "DEF-f_pinky.01.R.01", "DEF-f_pinky.01.R.02",
                     "DEF-f_pinky.02.L", "DEF-f_pinky.02.R",
                     "DEF-f_pinky.03.L", "DEF-f_pinky.03.R", "DEF-f_ring.01.L.01", "DEF-f_ring.01.L.02",
                     "DEF-f_ring.01.R.01", "DEF-f_ring.01.R.02",
                     "DEF-f_ring.02.L", "DEF-f_ring.02.R", "DEF-f_ring.03.L", "DEF-f_ring.03.R", "DEF-foot.L",
                     "DEF-foot.R", "DEF-forearm.01.L", "DEF-forearm.01.R",
                     "DEF-forearm.02.L", "DEF-forearm.02.R", "DEF-hand.L", "DEF-hand.R", "DEF-head", "DEF-hips",
                     "DEF-neck", "DEF-palm.01.L", "DEF-palm.01.R",
                     "DEF-palm.02.L", "DEF-palm.02.R", "DEF-palm.03.L", "DEF-palm.03.R", "DEF-palm.04.L",
                     "DEF-palm.04.R", "DEF-shin.01.L", "DEF-shin.01.R", "DEF-shin.02.L",
                     "DEF-shin.02.R", "DEF-shoulder.L", "DEF-shoulder.R", "DEF-spine", "DEF-thigh.01.L",
                     "DEF-thigh.01.R", "DEF-thigh.02.L", "DEF-thigh.02.R",
                     "DEF-thumb.01.L.01", "DEF-thumb.01.L.02", "DEF-thumb.01.R.01", "DEF-thumb.01.R.02",
                     "DEF-thumb.02.L", "DEF-thumb.02.R", "DEF-thumb.03.L",
                     "DEF-thumb.03.R", "DEF-tie.00", "DEF-tie.01", "DEF-tie.02", "DEF-toe.L", "DEF-toe.R",
                     "DEF-upper_arm.01.L", "DEF-upper_arm.01.R", "DEF-upper_arm.02.L",
                     "DEF-upper_arm.02.R", "ORG-heel.02.L", "ORG-heel.02.R", "ORG-heel.L", "ORG-heel.R",
                     "ORG-palm.01.L", "ORG-palm.01.R", "ORG-palm.02.L",
                     "ORG-palm.02.R", "ORG-palm.03.L", "ORG-palm.03.R", "ORG-palm.04.L", "ORG-palm.04.R",
                     "MCH-elbow_hose_p.R", "elbow_hose.R", "MCH-forearm_hose_p.R",
                     "forearm_hose.R", "MCH-forearm_hose_end_p.R", "forearm_hose_end.R", "MCH-upper_arm_hose_end_p.R",
                     "upper_arm_hose_end.R", "MCH-upper_arm_hose_p.R",
                     "upper_arm_hose.R", "MCH-elbow_hose_p.L", "elbow_hose.L", "MCH-forearm_hose_p.L", "forearm_hose.L",
                     "MCH-forearm_hose_end_p.L", "forearm_hose_end.L",
                     "MCH-upper_arm_hose_end_p.L", "upper_arm_hose_end.L", "MCH-upper_arm_hose_p.L", "upper_arm_hose.L",
                     "MCH-knee_hose_p.L", "knee_hose.L", "MCH-shin_hose_p.L",
                     "shin_hose.L", "MCH-shin_hose_end_p.L", "shin_hose_end.L", "MCH-thigh_hose_end_p.L",
                     "thigh_hose_end.L", "MCH-thigh_hose_p.L", "thigh_hose.L",
                     "MCH-knee_hose_p.R", "knee_hose.R", "MCH-shin_hose_p.R", "shin_hose.R", "MCH-shin_hose_end_p.R",
                     "shin_hose_end.R", "MCH-thigh_hose_end_p.R",
                     "thigh_hose_end.R", "MCH-thigh_hose_p.R", "thigh_hose.R"]

    bones_to_unhide = ["ORG-chest", "ORG-f_index.01.L", "ORG-f_index.01.R", "ORG-f_index.02.L", "ORG-f_index.02.R",
                       "ORG-f_index.03.L",
                       "ORG-f_index.03.R", "ORG-f_middle.01.L", "ORG-f_middle.01.R", "ORG-f_middle.02.L",
                       "ORG-f_middle.02.R", "ORG-f_middle.03.L",
                       "ORG-f_middle.03.R", "ORG-f_pinky.01.L", "ORG-f_pinky.01.R", "ORG-f_pinky.02.L",
                       "ORG-f_pinky.02.R", "ORG-f_pinky.03.L", "ORG-f_pinky.03.R",
                       "ORG-f_ring.01.L", "ORG-f_ring.01.R", "ORG-f_ring.02.L", "ORG-f_ring.02.R", "ORG-f_ring.03.L",
                       "ORG-f_ring.03.R", "ORG-foot.L", "ORG-foot.R",
                       "ORG-forearm.L", "ORG-forearm.R", "ORG-hand.L", "ORG-hand.R", "ORG-head", "ORG-hips", "ORG-neck",
                       "ORG-shin.L", "ORG-shin.R", "ORG-shoulder.L",
                       "ORG-shoulder.R", "ORG-spine", "ORG-thigh.L", "ORG-thigh.R", "ORG-thumb.01.L", "ORG-thumb.01.R",
                       "ORG-thumb.02.L", "ORG-thumb.02.R",
                       "ORG-thumb.03.L", "ORG-thumb.03.R", "ORG-toe.L", "ORG-toe.R", "ORG-upper_arm.L",
                       "ORG-upper_arm.R", "EXT-jaw", "EXT-eye.R", "EXT-eye.L",
                       "EXT-tie.01", "EXT-tie.02", "EXT-tie.03"]
...
def add_extra_bones(context):
    ...
    jaw = add_bone(context, obj, head.head + Vector((0, -0.1, 0)), head.head + Vector((0, -0.15, 0)), 0, ext, "jaw",
                   head, False)
    eyeR = add_bone(context, obj, head.head + Vector((-0.036, -0.1, 0.1)), head.head + Vector((-0.036, -0.15, 0.1)), 0,
                    ext, "eye.R", head, False)
    eyeL = add_bone(context, obj, head.head + Vector((0.036, -0.1, 0.1)), head.head + Vector((0.036, -0.15, 0.1)), 0,
                    ext, "eye.L", head, False)

    interactionR = add_bone(context, obj, root.head + Vector((-1, 0, 1)), root.head + Vector((-1, -0.1, 1)), 0, ext,
                            "interaction.R", root, False)
    interactionL = add_bone(context, obj, root.head + Vector((1, 0, 1)), root.head + Vector((1, -0.1, 1)), 0, ext,
                            "interaction.L", root, False)

    aimR = add_bone(context, obj, root.head + Vector((-1, 0, 1.5)), root.head + Vector((-1, -0.1, 1.5)), 0, aim,
                    "hand.R", root, True)
    aimL = add_bone(context, obj, root.head + Vector((1, 0, 1.5)), root.head + Vector((1, -0.1, 1.5)), 0, aim, "hand.L",
                    root, True)

    attachHandR = add_bone(context, obj, handR.tail, handR.vector * 0.3 + handR.tail, handR.roll, att, "hand.R", handR,
                           True)
    attachHandL = add_bone(context, obj, handL.tail, handL.vector * 0.3 + handL.tail, handL.roll, att, "hand.L", handL,
                           True)
...
def align_pose_bones(context):
    ...
    if sel == 2:
        ...
        print("Dunno what to do... Please select only ONE other object. You have currently selected",
              len(C.selected_objects) - 1)
